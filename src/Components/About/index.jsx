      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h1
          ...
          initial={{
            opacity: 0,
            y: -30,
            textShadow: "0px 0px 0px rgba(72, 187, 120, 0)",
          }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          whileHover={{
            textShadow:
              "0 0 8px rgba(72, 187, 120, 0.9), 0 0 20px rgba(72, 187, 120, 0.7)",
            scale: 1.05,
        ...
        >
          Bem-vindo ao{" "}
          <strong className="font-black text-green-900">ShopHere</strong>, a
          plataforma feita para você descobrir produtos incríveis, comparar
        ...
        <div className="grid gap-14 sm:grid-cols-2 md:grid-cols-3">
          {equipe.map((membro, index) => (
            ...
            >
              ...
              />
              <h4 className="text-center text-2xl font-extrabold text-green-900">
                {membro.nome}
              </h4>
