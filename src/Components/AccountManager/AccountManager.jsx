...
import { FiUser, FiSettings, FiMoon, FiBell, FiLogOut, FiChevronRight, FiX } from 'react-icons/fi';
      ...
      <aside className="w-64 bg-white p-6">
        ...
        <nav className="space-y-4">
          <button className="w-full flex items-center justify-between py-2">
            <span className="flex items-center gap-2"><FiUser /> Meu Perfil</span>
            <FiChevronRight />
          </button>
          <button
          ...
          >
            <span className="flex items-center gap-2"><FiSettings /> Configurações</span>
            <FiChevronRight />
          </button>
          <button
            className="w-full flex items-center justify-between py-2"
          ...
          >
            <span className="flex items-center gap-2"><FiMoon /> Modo Escuro</span>
          ...
          >
            <span className="flex items-center gap-2"><FiBell /> Notificação</span>
        ...
        <div className="max-w-xl bg-white p-6 rounded-2xl">
          ...
          <div className="space-y-4">
            <div className="flex justify-between border-b pb-2">
              <span>Nome</span>
              <input type="text" defaultValue="Seu Nome" className="text-right w-2/3 focus:outline-none" />
            </div>
            <div className="flex justify-between border-b pb-2">
              <span>Conta de Email</span>
              <input type="email" defaultValue="seuemail@gmail.com" className="text-right w-2/3 focus:outline-none" />
            </div>
            <div className="flex justify-between border-b pb-2">
